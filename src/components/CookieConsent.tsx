...
export const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-gradient-to-r from-card/95 via-background/95 to-card/95 backdrop-blur-xl border-t border-primary/30 shadow-2xl animate-slide-up">
