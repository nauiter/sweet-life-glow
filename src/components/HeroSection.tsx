...
export const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-[85vh] sm:min-h-screen flex items-center justify-center overflow-hidden pt-32 sm:pt-36 md:pt-40" aria-label="Hero section - Welcome to Sweet Life Animes">
