...
export const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-44 sm:pt-48 md:pt-52" aria-label="Hero section - Welcome to Sweet Life Animes">
