  ...
  return (
    <div className="fixed bottom-20 md:bottom-6 right-3 md:right-6 z-40">
      ...
      >
        <Button
          size="default"
          className="group bg-yellow-500 hover:bg-yellow-600 text-white font-bold shadow-2xl hover:shadow-yellow-500/50 hover:scale-105 active:scale-95 transition-all duration-300 px-3 py-2 md:px-6 md:py-6 rounded-xl md:rounded-2xl border-2 border-yellow-400 text-xs md:text-base"
        >
